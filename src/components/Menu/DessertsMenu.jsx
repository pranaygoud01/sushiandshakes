  ...
  return (
    <div className="bg-white text-neutral-800">
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 max-lg:py-6">
        <h1 className="text-4xl max-lg:text-xl font-bold uppercase text-center mb-4">Desserts Menu</h1>
        

        {sections.map((section, i) => (
          <div key={i} className="mb-12">
            <h2 className="text-xl max-lg:text-lg font-bold border-b-2 border-orange-500 inline-block mb-6 uppercase tracking-wide">{section.title}</h2>
            <div className="space-y-6">
              {section.items.map((item, idx) => (
                <div key={idx} className="border-b  border-b-neutral-300 pb-4">
