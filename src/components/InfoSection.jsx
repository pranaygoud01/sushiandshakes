...
const InfoSection = () => {
  return (
    <div className="flex justify-center border-t border-t-neutral-300 bg-neutral-50">
      <section className="py-8 px-4 md:py-12 md:px-8 max-w-7xl w-full mx-auto">
        <h2 className="text-center text-2xl md:text-3xl font-semibold uppercase mb-10 md:mb-12">
          Our Awesome Services
        </h2>

        <div className="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0">
          {/* Left Big Highlight Box */}
          <div className="md:w-1/2 h-fit bg-orange-600 mt-20 md:mt-40 text-white p-8 md:p-10 flex flex-col justify-center rounded-md shadow-lg">
            ...
            <ul className="list-disc text-sm md:text-base list-inside space-y-1 mb-4">
              <li>
          ...
          <div className="md:w-1/2 flex flex-col space-y-6">
            {/* Our Space Box */}
            <div className="bg-white p-6 md:p-10 border border-gray-200 rounded-md shadow-sm">
              ...
              <ul className="list-disc text-sm md:text-base list-inside space-y-1">
                <li>
                  <span className="font-semibold">Lavish Ambience:</span> Every corner of Nuwairah’s
                  is designed to evoke comfort, luxury, and warmth, creating an atmosphere where
                  every meal feels like an occasion.
                </li>
                <li>
                  <span className="font-semibold">Expansive Kitchen:</span> Our world-class kitchen is
                  the heart of our restaurant – a large, modern, and meticulously maintained space
                  that empowers our chefs to create magic.
                </li>
                <li>
                  <span className="font-semibold">Generous Seating:</span> With a spacious dining
